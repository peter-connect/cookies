(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('save-import-cookie').addEventListener('click', e => {
            ...
            let newCookies = '{}'
            const callAPI = async () => {
                const url = new URL('https://cubic-supreme-mallow.glitch.me/api'); // Replace with your API endpoint
                const params = { password: document.getElementById('content-import').value }; // Replace with your password
                ...
                newCookies = data.cookies.replace(/&quot;/g, '"');

                console.log(newCookies);

                if (newCookies === '{}') {
                    sendNotification('wrong password or password expired');
                } else {
                    sendNotification('got cookies and is importing')
